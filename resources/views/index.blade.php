...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet"  href={{ URL::asset('content/css/vendor/bootstrap.min.css')}}>
    ...
    <link rel="stylesheet" href={{ URL::asset('content/css/main-ltr.css')}}>
  </head>
  <body>
    <main class="home-page">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-center text-lg-start">
              ...
              @foreach ($categories as $category)
                 ...
                 <li class="nav-item"><a class="nav-link" href="{{ route('product',['category'=>$category->id])  }}">{{ $category->catName }}</a></li>
      ...
      <section class="py-5 categories">
        <div class="container">
          ...
          @foreach ($categories as $category)
          <div class="col mb-3">
            <div class="categories__box"><a class="categories__link d-block p-4 border" href="#{{ $category->catName }}">{{ $category->catName }}</a></div>
          </div>
          @endforeach
      ...
      <!-- Start Men -->
            @foreach ( $categories as $category)
            <section class="men bg-bage-content py-5" id={{$category->catName }}>
                <div class="container">
                  <div class="title-section mb-4">
                    <h2 class="text__title">{{ $category->catName }}</h2>
                  </div>
                          ...
                          <div class="col-6">
                            ...
                            <div class="product-body">
                              ...
                              <div class="d-flex justify-content-between flex-wrap pt-3 border-top">
                                ...
                                <p class="card-text">{{ $product->price }} EG</p>
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                ...
                <div class="view-more text-center"><a class="btn main-more" href="{{ route('product',['category'=>$category->id]) }}">View More</a><a class="btn main-more" href="{{ route('product',['category'=>$category->id]) }}">View More</a></div>
    ...
    <script src={{ URL::asset('content/js/vendor/owl.carousel.min.js') }}> </script><script type="module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.esm.js"></script>
<script nomodule src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script>
    <script src={{ URL::asset('content/js/main.js') }}> </script>
    <script src={{ URL::asset('content/js/home.js') }}> </script>
  </body>
</html>
