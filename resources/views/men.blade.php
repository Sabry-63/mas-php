    ...
    <main class="product-page">
        ...
        <div class="container"><a class="navbar-brand" href="#"> <img src="content/assets/images/logo/logo.png" alt=""></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-center text-lg-start">
                @foreach ($allcat as $categoryq)

                <li class="nav-item"><a class="nav-link" href="{{ route('product',['category'=>$categoryq->id])}}">{{ $categoryq->catName }}</a></li>
             @endforeach
              <li class="nav-item">
                <div class="dropdown">
      ...
      <header class="header" id="header">
        <div class="header__bg">
          <div class="row">
            <div class="col-lg-6">  <img src= {{ asset($category->image) }} alt="men"> </div>
            <div class="col-lg-6">
                      ...
                      <div class="col-6">
                        <div class="product-body">
                          <div class="img-slider owl-theme owl-carousel">
                           ...
                           <div class="item"><img class="card-img" src="{{ URl::asset($image->imageName) }}" alt="T-shirt"></div>
...
<script nomodule src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script>
    ...
    <script src="{{ URL::asset('content/js/product.js') }}"> </script>
  </body>
</html>
